  ...
  return (
    <header className="navbar8-container1">
      <header data-thq="thq-navbar" className="navbar8-navbar-interactive">
          ...
          <div className="navbar8-buttons1">
            ...
            >
              <span className="thq-body-small">
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text25">Upload Image</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="navbar8-action21 thq-button-outline thq-button-animated">
              <span className="thq-body-small">
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text22">Send Message</span>
                  </Fragment>
                )}
              </span>
            </button>
        ...
        {showPopup && <ImageUpload onClose={handleClosePopup} />}
                            ...
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text23 thq-body-small">
                                  Get information on plant health, prevention,
                                  and supplements
                                </span>
                              </Fragment>
                            )}
                  ...
                  <div className="navbar8-content7">
                    ...
                    <span>
                      {props.page3Description ?? (
                        <Fragment>
                          <span className="navbar8-text23 thq-body-small">
                            Get information on plant health, prevention, and
                            supplements
                          </span>
                        </Fragment>
                      )}
...
Navbar8.defaultProps = {
  ...
  page2: undefined,
  link2: undefined,
  page2ImageAlt: "Illustration of plant disease detection process",
  page3ImageSrc:
  ...
  page3ImageAlt: "Illustration of plant health information",
  link1: undefined,
  linkUrlPage1: "https://www.teleporthq.io",
  link2Url: "https://www.teleporthq.io",
  logoAlt: "PlantAI Logo",
  action2: undefined,
  link1Url: "https://www.teleporthq.io",
  page4ImageAlt: "Illustration of contact information",
  page1ImageAlt: "Illustration of a healthy plant",
