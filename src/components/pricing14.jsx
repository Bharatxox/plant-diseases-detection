        ...
        <div className="pricing14-section-title">
          ...
          <div className="pricing14-content">
            <h2>
              {props.heading1 ?? (
                <Fragment>
                  <h2 className="pricing14-text171 thq-heading-2">
                    Pricing plan
                  </h2>
                </Fragment>
              )}
              ...
              <div className="pricing14-price18">
                <div className="pricing14-price19">
                  ...
                  <span>
                    {props.plan2Yearly1 ?? (
                      <Fragment>
                        <span className="pricing14-text188 thq-body-large">
                          or $29 monthly
                        </span>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price20">
                <div className="pricing14-price21">
                  ...
                  <h3>
                    {props.plan3Price1 ?? (
                      <Fragment>
                        <h3 className="pricing14-text192 thq-heading-3">
                          $499/yr
                        </h3>
                      </Fragment>
                    )}
                  ...
                  <span>
                    {props.plan3Yearly1 ?? (
                      <Fragment>
                        <span className="pricing14-text174 thq-body-large">
                          or $49 monthly
                        </span>
                      </Fragment>
                    )}
