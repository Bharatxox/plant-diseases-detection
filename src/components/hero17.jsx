            ...
            {props.content1 ?? (
              <Fragment>
                <p className="hero17-text6 thq-body-large">
                  Detect plant diseases quickly and accurately with our
                  cutting-edge AI technology. Simply upload an image for
                  analysis and receive detailed results in seconds.
                </p>
              </Fragment>
            )}
          </p>
...
Hero17.defaultProps = {
  ...
  image1Alt: "AI-Powered Plant Disease Detection",
