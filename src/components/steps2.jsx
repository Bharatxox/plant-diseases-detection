          ...
          <div className="steps2-container3">
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text28 thq-body-small">
                      Select an image of the plant you want to analyze for
                      disease.
                    </span>
                  </Fragment>
                )}
            ...
            <div className="steps2-container5 thq-card">
              <h2>
                {props.step2Title ?? (
                  <Fragment>
                    <h2 className="steps2-text26 thq-heading-2">AI Analysis</h2>
                  </Fragment>
                )}
              </h2>
              <span>
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text30 thq-body-small">
                      Our AI technology will examine the image to detect any
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text27 thq-body-small">
                      Get detailed information on the detected disease,
                      prevention tips, and suggested supplements.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text25 thq-body-small">
                      Ask our AI-powered chatbot any questions related to plant
                      health and receive instant answers.
                    </span>
                  </Fragment>
                )}
              </span>
